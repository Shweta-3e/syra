...
namespace Syra.Admin.Controllers
{
    public class MessagesController : Controller
    {
        ...
        {
            var messages = db.Messages.Include(m => m.Customer);
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,Text,OrderBy")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,Text,OrderBy")] Message message)
        {
            if (ModelState.IsValid)
            {
