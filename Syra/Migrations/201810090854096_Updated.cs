    ...
    public partial class Updated : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        BlobConnectionString = c.String(),
                        ContainerName = c.String(),
                        WebSiteUrl = c.String(),
                        DeleteDate = c.DateTime(nullable: false),
                        LuisId = c.Long(nullable: false),
                        InheritStandardQA = c.Boolean(nullable: false),
                        HasAdditionalResponse = c.Boolean(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        IsPlanActive = c.Boolean(nullable: false),
                        DeploymentScript = c.String(),
                        EmbeddedScript = c.String(),
                        T_BotClientId = c.String(),
                        DomainKey = c.String(),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                .Index(t => new { t.IEKey, t.BotDomainId, t.BotDeploymentId }, unique: true, name: "IX_IE_DOMAIN_DEPLOY_UX");
